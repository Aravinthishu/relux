...
const AppCTA = () => {
  return (
    <div className="flex  flex-col lg:flex-row items-center justify-between bg-white w-full p-1  md:p-8 md:w-10/12 mx-auto  h-screen mb-10">
      
      <div className=" w-1/2  justify-center lg:justify-start mb-4 lg:mb-0">
        <img src="/path-to-phone-image.png" alt="App Screenshot" className="w-40 sm:w-56 md:w-64 lg:w-80 shadow-xl rounded-lg" />
      </div>

      <div className="flex flex-col md:w-1/2  text-center lg:text-left px-5 gap-10  ">
      <div className='flex flex-col gap-5'>
        <h4 className="text-green-600 font-semibold text-xs sm:text-sm uppercase mb-1 sm:mb-2">New Generation</h4>
        <h1 className="text-2xl sm:text-3xl md:text-7xl font-semibold text-black mb-2 sm:mb-4 leading-tight">
